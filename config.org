...
(defun setup-tide-mode ()
  (interactive)
  ;; (setq tide-node-executable "/home/eoshiru/.nvm/versions/node/v9.0.0/bin/node")
...
(use-package names :ensure t :defer t)
#+END_SRC
LC-Emacs
Beware: there are multiple version if you =:ensure t= the use package instruction it will get another version than the one from gh
#+BEGIN_SRC emacs-lisp
(add-to-list 'load-path (expand-file-name "~/.emacs.d/elpa/leetcode"))
(use-package leetcode
  :config
  (setq leetcode-path "~/dev/leetcode"
...
* Languages
** JavaScript
Requires =sudo npm install -g tern=
#+begin_src emacs-lisp
...
;;                               :prefix "SPC"
;;                               "m" '(:ignore t :which-key "Major Mode[JS]")
;;                               "mr" '(js-comint-repl :which-key "JS REPL")
;;                               ))
;;                            (tern-mode)
;;                            (company-mode)))

;; JS Setup via Tide (supports DOM Apis etc)
